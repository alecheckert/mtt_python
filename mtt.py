...
log-likelihood ratio test based on the assumption of a Gaussian point
spread function and Gaussian background noise. Detections are then
subjected to Gauss-Newton fitting (Gaussian PSF) and recorded. Next, 
